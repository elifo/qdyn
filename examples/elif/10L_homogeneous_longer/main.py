...
sys.path.append('/central/groups/enceladus/ELIF/CYCLES/QDYN/qdyn/src')  # For pyqdyn
#sys.path.append('/central/groups/enceladus/ELIF/CYCLES/QDYN/qdyn/utils/post_processing') # For plot_functions
print(sys.path)
